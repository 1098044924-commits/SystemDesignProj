...
-- 确保数据库和表的字符集正确
ALTER DATABASE gnucash_like CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE accounts CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE commodities CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- 先删除之前导入的乱码数据（根据代码前缀）
DELETE FROM accounts WHERE code LIKE 'A%' OR code LIKE 'L%' OR code LIKE 'E%' OR code LIKE 'I%' OR code LIKE 'EX%';
